...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      // Matches Input: a field the form is complaining about looks wrong, not
      // just reads wrong to a screen reader.
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Without a cap the menu grows to its longest label. One proposal
        // titled with a whole SOP header made it 1600px wide in a 658px
        // window, most of it off-screen.
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      // The label is the last child (the tick indicator is the first).
